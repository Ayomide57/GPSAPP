...
import TSMapView from './src/lib/TSMapView';

import {registerTransistorAuthorizationListener} from './src/lib/Authorization';
...
const App = ({route, navigation}) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{backgroundColor: 'gold', height: 56, flexDirection: 'row'}}>
        ...
        <View style={{justifyContent: 'center', padding: 5}}>
          <Button
            containerStyle={{width: 60}}
            buttonStyle={{backgroundColor: (isMoving) ? 'red' : 'green'}}
            onPress={onClickChangePace}
            //icon={<Icon name={(isMoving) ? 'pause-sharp' : 'play-sharp'} type='ionicon' color={'white'}/> }
          />
        </View>
      </View>
    </SafeAreaView>
